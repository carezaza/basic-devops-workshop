...
├── html/
│   ├── index.php
│   └── index_edit.php #นำ Code ในไฟล์นี้ไปแทนที่ Code ในไฟล์ index_edit.php เมื่อทำ Practice Workshop ถึงหน้า 169
├── mariadb/
│   ├── backup/
│   ├── data/
│   └── initdb/
...
└── python/
    ...
    │   ├── otp.html
    │   ├── otp_edit.html #นำ Code ในไฟล์นี้ไปแทนที่ Code ในไฟล์ otp_edit.html เมื่อทำ Practice Workshop ถึงหน้า 350
    │   ├── otp_edit2.html #นำ Code ในไฟล์นี้ไปแทนที่ Code ในไฟล์ otp_edit.html เมื่อทำ Practice Workshop ถึงหน้า 383
    │   ├── reg.html
